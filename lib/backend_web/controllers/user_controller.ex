defmodule BackendWeb.UserController do
  ...
  def create(conn, %{"user" => user_params}) do
    ...
    #      if user_params["city"] == nil || user_params["state"] == nil ||
    #           user_params["neighborhood_address"] == nil || user_params["street_address"] do
    #        "CEP inválido ou não informado, por favor informe cidade, estado, bairro e nome da rua."
    #      end

    #    conferir se os outros dados estão sendo passados
    #    caso não, retornar mensagem pedindo para informar os outros dados
  end
